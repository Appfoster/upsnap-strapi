 ...
 */
export const sortOptionToBackendParam = (sortOption: string | null): string | undefined => {
 ...
 */
export const getSortOrder = (sortOption: string | null): 'asc' | 'desc' | undefined => {
  if (!sortOption) return undefined;
 ...
 */
export const buildSortParam = (sortOption: string | null): string | undefined => {
