...
import {  BrokenLinksCheckData, DomainCheckData, LighthouseCheckData, MixedContentData, MonitorData, SSLCheckData, UptimeHealthCheckData } from '../../utils/types';
...
export const HealthCards = ({ monitorData, isLoading }: Props) => {
  ...
  const [lighthouseHealthCheck, setLighthouseHealthCheck] = useState<LighthouseCheckData | null>(null);
  const [domainHealthCheck, setDomainHealthCheck] = useState<DomainCheckData | null>(null);
  const [brokenLinksHealthCheck, setBrokenLinksHealthCheck] = useState<BrokenLinksCheckData | null>(null);
  const [mixedContentHealthCheck, setMixedContentHealthCheck] = useState<MixedContentData | null>(null);
